    ...
    <tbody>
      <tr style="vertical-align: top">
        <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                  <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                    ...
                                    <img align="center" border="0" src="{{ asset('images/mail_images/image-2.png') }}" alt="border" title="border"
                    ...
                    <div
                      ...
                      <table id="u_content_image_1" style="font-family:'Lato',sans-serif;" role="presentation"
                        ...
                        <tbody>
                          <tr>
                            <td
                              style="overflow-wrap:break-word;word-break:break-word;padding:5px 10px 30px;font-family:'Lato',sans-serif;"
                              align="left">
                                ...
                                <tr>
                                  <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                    <a href="https://unlayer.com" target="_blank">
                                      <img align="center" border="0" src="{{asset('dist/img/logo.png')}}" alt="Logo" title="Logo"
            ...
            <div class="u-row"
              ...
              <div style="border-collapse: collapse;display: table;width: 100%;background-color: transparent;">
                ...
                <div class="u-col u-col-100"
                  style="max-width: 320px;min-width: 600px;display: table-cell;vertical-align: top;">
                  <div
                    style="background-color: #f7f7f7;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                    <!--[if (!mso)&(!IE)]><!-->
                    <div
                      style="padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                      <!--<![endif]-->
                      ...
                      <table style="font-family:'Lato',sans-serif;" role="presentation" cellpadding="0" cellspacing="0"
                        ...
                        <tbody>
                          <tr>
                            <td
                              style="overflow-wrap:break-word;word-break:break-word;padding:15px 10px 40px;font-family:'Lato',sans-serif;"
                              align="left">
          ...
          <div class="u-row-container" style="padding: 0px;background-color: transparent">
            <div class="u-row"
              style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #f7f7f7;">
              <div style="border-collapse: collapse;display: table;width: 100%;background-color: transparent;">
                    ...
                    <div
                      ...
                      <table style="font-family:'Lato',sans-serif;" role="presentation" cellpadding="0" cellspacing="0"
                        ...
                        <tbody>
                          <tr>
                            <td
                              style="overflow-wrap:break-word;word-break:break-word;padding:0px 44px 8px;font-family:'Lato',sans-serif;"
                              align="left">

                              <div style="color: #333333; line-height: 190%; text-align: left; word-wrap: break-word;">
                                <p style="line-height: 190%; text-align: left; font-size: 14px;"><span
                                    style="font-size: 18px; line-height: 34.2px;">Vous venez d'&ecirc;tre ajout&eacute;
                                    comme Administrateur de l'application <strong><em>StudyUp</em></strong>&nbsp;
                                </p>
                                <p style="font-size: 14px; line-height: 190%;"><span
                                    style="font-size: 18px; line-height: 34.2px;"><span
                                      style="line-height: 34.2px; font-size: 18px;">Fournissez les informations
                                      suivantes &agrave; la page de connexion pour</span></span></p>
                                <p style="font-size: 14px; line-height: 190%;"><span
                                    style="font-size: 18px; line-height: 34.2px;"><span
                                      style="line-height: 34.2px; font-size: 18px;">acc&eacute;der &agrave; l'
                                      interface d'Administration:</span></span></p>
                                <p style="font-size: 14px; line-height: 190%;"><strong><span
                                      style="font-size: 18px; line-height: 34.2px;"><span
                                        style="line-height: 34.2px; font-size: 18px;">Email: <em><a rel="noopener"
                                            href="mailto:?subject=&amp;body="
                                            target="_blank">{{$email}}</a></em></span></span></strong>
                                </p>

                                <p style="font-size: 14px; line-height: 190%;"><strong><span
                                      style="font-size: 18px; line-height: 34.2px;"><span
                                        style="line-height: 34.2px; font-size: 18px;">Mot de passe:<em>
                                          {{$password}}</em></span></span></strong></p>

                                          <p style="font-size: 14px; line-height: 190%;"><strong><span
                                            style="font-size: 18px; line-height: 34.2px;"><span
                                              style="line-height: 34.2px; font-size: 18px;">Lien du pannel<em>
                                               <a href="http://bookstudy.smt-group.net/login">Login</a></em></span></span></strong></p>
                              </div>
                    ...
                    <div
                      ...
                      <table style="font-family:'Lato',sans-serif;" role="presentation" cellpadding="0" cellspacing="0"
                        ...
                        <tbody>
                          <tr>
                            <td
                              style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 20px;font-family:'Lato',sans-serif;"
                              align="left">

                              <div
                                style="color: #8d8c8c; line-height: 190%; text-align: center; word-wrap: break-word;">
                                <p style="font-size: 14px; line-height: 190%;">Tous droits réservés. Copyright © 2021-2022 StudyUp by Smart Touch Group</p>
                              </div>
