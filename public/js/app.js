...
var showHideBtn = document.querySelector('a[href="/eye"]');
showHideBtn.addEventListener('click', function (e) {
  e.preventDefault();
  var pswInput = document.querySelector('input[name="password"]');
  var classListArr = Array.from(e.target.classList);
